...
## 📜 License
This project is based on the [Astro Nano](https://github.com/markhorn-dev/astro-nano) template.
Original code is licensed under MIT. Content and photography &copy; 2026 Nicholas Drömert.
